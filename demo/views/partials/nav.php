          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4"> 
              <!-- Fix the hover functionality -->
                        ...
                        <a href="/websites/demo/index.php" class="<?= urlIs('index.php') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Home</a>
                        <a href="/websites/demo/about.php" class="<?= urlIs('about.php') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</a>
                        <a href="/websites/demo/notes.php" class="<?= urlIs('notes.php') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Notes</a>
                        <a href="/websites/demo/contact.php" class="<?= urlIs('contact.php') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
